...
public final class AApreslistedecvarListedecvarbis extends PListedecvarbis
{
    private TVirgule _virgule_;
    private PDecvar _decvar_;
    private PListedecvarbis _listedecvarbis_;

    public AApreslistedecvarListedecvarbis()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AApreslistedecvarListedecvarbis(
    ...
    {
        ((Analysis) sw).caseAApreslistedecvarListedecvarbis(this);
    }
