...
public final class ADeclarationfonctionDecfonc extends PDecfonc
{
    ...
    private PListedecvar _parametre_;
    private TRPar _rPar_;
    private PListedecvar _variablefonc_;
    ...
    public ADeclarationfonctionDecfonc(
        ...
        @SuppressWarnings("hiding") PListedecvar _parametre_,
        @SuppressWarnings("hiding") TRPar _rPar_,
        @SuppressWarnings("hiding") PListedecvar _variablefonc_,
        @SuppressWarnings("hiding") PInstrbloc _instrbloc_)
    {
        ...
        setVariablefonc(_variablefonc_);
    ...
    public PListedecvar getParametre()
    {
        return this._parametre_;
    }

    public void setParametre(PListedecvar node)
    {
    ...
    public PListedecvar getVariablefonc()
    {
        return this._variablefonc_;
    }

    public void setVariablefonc(PListedecvar node)
    {
        if(this._variablefonc_ != null)
        {
            this._variablefonc_.parent(null);
        }
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._variablefonc_ == child)
        {
            this._variablefonc_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setParametre((PListedecvar) newChild);
            return;
        }
        ...
        if(this._variablefonc_ == oldChild)
        {
            setVariablefonc((PListedecvar) newChild);
            return;
        }
