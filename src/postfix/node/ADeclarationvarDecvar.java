...
public final class ADeclarationvarDecvar extends PDecvar
{
    private PType _type_;
    private TIdentif _identif_;

    public ADeclarationvarDecvar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclarationvarDecvar(
    ...
    {
        ((Analysis) sw).caseADeclarationvarDecvar(this);
    }
