...
public final class AElsebranchElsebranch extends PElsebranch
{
    private PInstrbloc _instrbloc_;

    public AElsebranchElsebranch()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AElsebranchElsebranch(
    ...
    {
        ((Analysis) sw).caseAElsebranchElsebranch(this);
    }
