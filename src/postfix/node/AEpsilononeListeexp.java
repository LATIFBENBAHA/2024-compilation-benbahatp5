...
public final class AEpsilononeListeexp extends PListeexp
{
    private TEpsilon _epsilon_;

    public AEpsilononeListeexp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEpsilononeListeexp(
    ...
    {
        ((Analysis) sw).caseAEpsilononeListeexp(this);
    }
