...
public final class AEpsilonsevenListedecfonc extends PListedecfonc
{
    private TEpsilon _epsilon_;

    public AEpsilonsevenListedecfonc()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEpsilonsevenListedecfonc(
    ...
    {
        ((Analysis) sw).caseAEpsilonsevenListedecfonc(this);
    }
