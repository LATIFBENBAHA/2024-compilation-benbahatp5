...
public final class AEpsilonsixListedecvarbis extends PListedecvarbis
{
    private TEpsilon _epsilon_;

    public AEpsilonsixListedecvarbis()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEpsilonsixListedecvarbis(
    ...
    {
        ((Analysis) sw).caseAEpsilonsixListedecvarbis(this);
    }
