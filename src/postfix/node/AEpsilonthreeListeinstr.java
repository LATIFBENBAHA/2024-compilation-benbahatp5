...
public final class AEpsilonthreeListeinstr extends PListeinstr
{
    private TEpsilon _epsilon_;

    public AEpsilonthreeListeinstr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEpsilonthreeListeinstr(
    ...
    {
        ((Analysis) sw).caseAEpsilonthreeListeinstr(this);
    }
