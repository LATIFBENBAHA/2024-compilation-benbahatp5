...
public final class AEpsilontwoListeexpbis extends PListeexpbis
{
    private TEpsilon _epsilon_;

    public AEpsilontwoListeexpbis()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEpsilontwoListeexpbis(
    ...
    {
        ((Analysis) sw).caseAEpsilontwoListeexpbis(this);
    }
