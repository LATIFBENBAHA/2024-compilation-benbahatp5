...
public final class AThenbranchThenbranch extends PThenbranch
{
    private PInstrbloc _instrbloc_;

    public AThenbranchThenbranch()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AThenbranchThenbranch(
    ...
    {
        ((Analysis) sw).caseAThenbranchThenbranch(this);
    }
